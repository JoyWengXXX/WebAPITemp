...
using webAPITemp.DBContexts.EFCore;
...
namespace webAPITemp.DBContexts.EFCore.Migrations
{
    ...
    [Migration("20230518144546_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webAPITemp.Models.Entities.DefaultDB.Page", b =>
                {
            ...
            modelBuilder.Entity("webAPITemp.Models.Entities.DefaultDB.Permission", b =>
                {
            ...
            modelBuilder.Entity("webAPITemp.Models.Entities.DefaultDB.Role", b =>
                {
                    b.Property<int>("RoleID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("webAPITemp.Models.Entities.DefaultDB.System", b =>
                {
                    b.Property<int>("SystemID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("webAPITemp.Models.Entities.DefaultDB.User", b =>
                {
            ...
            modelBuilder.Entity("webAPITemp.Models.Entities.DefaultDB.UserPasswordRecord", b =>
                {
                    b.Property<int>("SerialNum")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
